...
class LexiconRu:
    ...
    problems: str = ('Что-то пошло не так\n'
                     'Нажмите: /start')
    state_is_on: str = ('Бот находится в постоянном ожидании суммы(числа).\n'
                        'Вам нужно:\n'
                        '1. Ввести сумму.\n'
                        '2. Выбрать одно из направлений:\n'
                        '-> Доходы/Расходы\n'
                        '3. Выбрать категорию для записи транзакции.\n\n'
                        'Сейчас ожидается ввод числа…')
    state_is_off: str = ('Бот находится в постоянном ожидании суммы(числа).\n'
                         'Вам нужно:\n'
                         '1. Ввести сумму.\n'
                         '2. Выбрать одно из направлений:\n'
                         '-> Доходы/Расходы\n'
                         '3. Выбрать категорию для записи транзакции.\n\n'
                         'Нажмите /start что-бы запустить работу бота.')
